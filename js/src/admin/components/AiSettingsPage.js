...
export default class AiSettingsPage extends ExtensionPage {
  ...
  setDefaultSettings() {
    // 如果没有设置provider，设置默认值为openai
    if (!this.setting('leot-ai-support-widget.provider')()) {
      this.setting('leot-ai-support-widget.provider')('openai');
    }
    
    // 如果没有设置widget_position，设置默认值为bottom-right
    if (!this.setting('leot-ai-support-widget.widget_position')()) {
      this.setting('leot-ai-support-widget.widget_position')('bottom-right');
    }
    
    // 如果没有设置theme，设置默认值为light
    if (!this.setting('leot-ai-support-widget.theme')()) {
      this.setting('leot-ai-support-widget.theme')('light');
    }
  }
